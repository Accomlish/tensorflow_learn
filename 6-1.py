...
#卷积层
def conv2d(x,W):
    # x: input a tensor of shape [batch,in_height,in_width,in_channels]
    # W: 一个滤波器（卷积核） tensor of shape[filter_height,filter_width,in_channels,out_channels]
...
#池化层
def max_pool_2x2(x):
    #ksize: 表示池化窗口2，2表示x和y方向长度
    #stride：2，2表示x和y方向的步长
